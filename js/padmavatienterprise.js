 /* --------------------------------------------------
  * © Copyright 2020 - RevaAmrut by padmavatienterprise
  * --------------------------------------------------*/
(function($) {
	'use strict';
     ...
     function load_owl() {
         ...
         jQuery("#healthbenefits-carousel").owlCarousel({
            center: true,
			items:3,
            loop:true,
            autoplay:true,
    ...
    tpj(document).ready(function() {
        if(tpj("#rev_slider_90_1").revolution == undefined){
            ...
            revapi90 = tpj("#rev_slider_90_1").show().revolution({
                ...
                responsiveLevels:[2560,1440,1240,1024,778,480,376,321],
                visibilityLevels:[2560,1440,1240,1024,778,480,376,321],
                gridwidth:[2560,1440,1240,1024,778,480,376,321],
                gridheight:[2560,1440,1240,1024,778,480,376,321],
                lazyType:"none",
                parallax: {
                    type:"scroll",
                    origo:"slidercenter",
